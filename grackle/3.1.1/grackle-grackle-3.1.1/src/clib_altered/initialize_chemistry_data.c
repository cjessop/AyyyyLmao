...
extern void FORTRAN_NAME(calc_rates_g)(
     ...
     double *k56, double *k57, double *k58, double *k59, double *k60, double *k61,
     double *k62, double *k63, double *k64, double *k65, double *k66, double *k67,
     double *k68, double *k69, double *k70, double *k71, double *k72, double *k73,
     int *ndratec, double *dtemstart, 
...
# endif
  ...
  /* Allocate space in my_rates for rates. */
    ...
    my_rates->k59 = malloc(my_chemistry->NumberOfTemperatureBins * sizeof(double));
    my_rates->k60 = malloc(my_chemistry->NumberOfTemperatureBins * sizeof(double));
    my_rates->k61 = malloc(my_chemistry->NumberOfTemperatureBins * sizeof(double));
    my_rates->k62 = malloc(my_chemistry->NumberOfTemperatureBins * sizeof(double));
    my_rates->k63 = malloc(my_chemistry->NumberOfTemperatureBins * sizeof(double));
    my_rates->k64 = malloc(my_chemistry->NumberOfTemperatureBins * sizeof(double));
    my_rates->k65 = malloc(my_chemistry->NumberOfTemperatureBins * sizeof(double));
    my_rates->k66 = malloc(my_chemistry->NumberOfTemperatureBins * sizeof(double));
    my_rates->k67 = malloc(my_chemistry->NumberOfTemperatureBins * sizeof(double));
    my_rates->k68 = malloc(my_chemistry->NumberOfTemperatureBins * sizeof(double));
    my_rates->k69 = malloc(my_chemistry->NumberOfTemperatureBins * sizeof(double));
    my_rates->k70 = malloc(my_chemistry->NumberOfTemperatureBins * sizeof(double));
    my_rates->k71 = malloc(my_chemistry->NumberOfTemperatureBins * sizeof(double));
    my_rates->k72 = malloc(my_chemistry->NumberOfTemperatureBins * sizeof(double));
    my_rates->k73 = malloc(my_chemistry->NumberOfTemperatureBins * sizeof(double));
  ...
  FORTRAN_NAME(calc_rates_g)(
     ...
     my_rates->k50, my_rates->k51, my_rates->k52, my_rates->k53, my_rates->k54,
        my_rates->k55, my_rates->k56, my_rates->k57, my_rates->k58,  my_rates->k59,
     my_rates->k60, my_rates->k61, my_rates->k62, my_rates->k63, my_rates->k64,
     my_rates->k65, my_rates->k66, my_rates->k67, my_rates->k68, my_rates->k69,
     my_rates->k70, my_rates->k71, my_rates->k72, my_rates->k73,
...
int _free_chemistry_data(chemistry_data *my_chemistry,
  ...
  if (my_chemistry->primordial_chemistry > 0) {
    ...
    GRACKLE_FREE(my_rates->k59);
    GRACKLE_FREE(my_rates->k60);
    GRACKLE_FREE(my_rates->k61);
    GRACKLE_FREE(my_rates->k62);
    GRACKLE_FREE(my_rates->k63);
    GRACKLE_FREE(my_rates->k64);
    GRACKLE_FREE(my_rates->k65);
    GRACKLE_FREE(my_rates->k66);
    GRACKLE_FREE(my_rates->k67);
    GRACKLE_FREE(my_rates->k68);
    GRACKLE_FREE(my_rates->k69);
    GRACKLE_FREE(my_rates->k70);
    GRACKLE_FREE(my_rates->k71);
    GRACKLE_FREE(my_rates->k72);
    GRACKLE_FREE(my_rates->k73);
